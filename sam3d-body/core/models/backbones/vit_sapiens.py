...
from ..modules.embed import PatchEmbed, resize_pos_embed

from ..modules.transformer import build_norm_layer, TransformerEncoderLayer

logger = get_pylogger(__name__)


def build_vit(arch, cfg=None):
    # Convert [w, h] in cfg.MODEL.IMAGE_SIZE to [h, w] for Transformer
    ...
    return VisionTransformer(
        ...
        out_type="featmap",
        patch_cfg=dict(padding=cfg.MODEL.BACKBONE.PATCH_PADDING),
    )
...
class VisionTransformer(nn.Module):
    ...
    def _prepare_pos_embed(self, state_dict, prefix, *args, **kwargs):
        ...
        if self.pos_embed.shape != ckpt_pos_embed_shape:
            ...
            if ckpt_pos_embed_shape[1] == 3072:  # FIXME: hard-coded for Sapiens
                ckpt_pos_embed_shape = (64, 48)
            else:
