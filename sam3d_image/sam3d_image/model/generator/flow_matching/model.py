...
from sam3d_image.model.backbone.generator.base import Base
from sam3d_image.model.backbone.utils.struct_utils import right_broadcasting
from sam3d_image.model.backbone.utils.struct_utils import tree_tensor_map, tree_reduce_unique
from sam3d_image.model.backbone.generator.flow_matching.solver import (
    ODESolver,
    Euler,
    Midpoint,
    RungeKutta4,
...
class FlowMatching(Base):
    ...
    def _generate_noise_tensor(self, x_shape, x_device):
        return torch.randn(
            ...
            device=self.random_generator.device,
        ).to(x_device)
    ...
    def _generate_dynamics(
        ...
        **kwargs_conditionals,
        ...
        return self.reverse_fn(x_t, t, *args_conditionals, **kwargs_conditionals)
